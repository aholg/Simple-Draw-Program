...
public class ControllerTest {
	...
	public void testNewCommand() throws NoCommandFoundException, Exception {
		...
		doTestEligibleCommand("C");
		doTestEligibleCommand("Q");
	}

	@Test
	public void testCanvas() throws NoCommandFoundException, Exception {
		testObsderver testObserver=new testObsderver();
		Controller canvasController=new Controller(testObserver);
		String testCanvas="----------------------\n"
						+ "|                    |\n"
						+ "|                    |\n"
						+ "|                    |\n"
						...
						+ "|                    |\n"
						+ "----------------------\n";
		canvasController.newCommand("C 20 10");
		assertEquals(testCanvas, testObserver.getLastOutput());
	}
